export default defineI18nLocale(() => ({
  ...
  home: {
    ...
    hero: {
      description:
        "Как фриланс Full Stack Developer, я разрабатываю высококачественные веб-сайты, платформы электронной коммерции, мобильные приложения и индивидуальные программные решения для клиентов.",
      role: "Программист",
      greeting: "Привет, я",
      roles: {
        name: "Suhan Begenjov",
