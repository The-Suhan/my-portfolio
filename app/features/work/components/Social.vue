...
<template>
    <div class="social-row">
        <!-- Live project -->
        <div class="icon-wrap">
            <button class="social-btn" :aria-label="$t('work.liveProject')" @click="openLink(liveUrl)">
        ...
        <!-- GitHub -->
        <div class="icon-wrap">
            <button class="social-btn" :aria-label="$t('work.githubRepo')" @click="openLink(githubUrl)">
